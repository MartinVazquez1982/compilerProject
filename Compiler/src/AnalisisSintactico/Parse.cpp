...
{TablaDeSimbolos::changeKey(yyvsp[0]);TablaDeSimbolos::setUso(yyvsp[0], "Var");}
break;
case 25:
...
{TablaDeSimbolos::changeKey(yyvsp[-2]);TablaDeSimbolos::setUso(yyvsp[-2], "Funcion");Ambito::add(yyvsp[-2]);}
break;
case 33:
